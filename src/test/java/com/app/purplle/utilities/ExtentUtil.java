package com.app.purplle.utilities;
...
public class ExtentUtil {
    ...
    public static ExtentReports createReporter(String fileName) {
        ...
        extentHtmlReporter.config().setReportName("Purplle Automation Report");
        extentHtmlReporter.config().setDocumentTitle("Purplle Automation Report");
        ...
        extentReports.setSystemInfo("Appium Version", "7.0.0");
        extentReports.setSystemInfo("Selenium Version", "3.14.0");
